# surgeist-retained Repository Guide
...
This independent leaf repository owns its manifest, retained-domain
...
`surgeist-retained` owns retained identity and state, canonical tree identity,
stable handles, and interaction state. It excludes layout, style, rendering,
platform, and application execution. Surgeist-to-Surgeist lowering and adapters
belong to root, and sibling internals are not this repository's surface.
